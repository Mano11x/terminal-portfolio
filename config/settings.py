...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-_3=xyfv^yv#!5qy-=-j)j@ishg81mllovl$gr*w807xv1_4p6=')
...
STATIC_URL = '/static/'
# Where `collectstatic` gathers files for deployment (e.g. on Render/Railway).
